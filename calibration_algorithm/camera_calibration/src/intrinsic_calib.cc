...
int main(int argc, char** argv)
{
    ...
    desc.add_options()
        ...
        ("size,s", boost::program_options::value<float>(&squareSize)->default_value(70.f), "Size of one square in mm")
        ...
        ("prefix,p", boost::program_options::value<std::string>(&prefix)->default_value(""), "Prefix of images")
        ...
        ("camera-name", boost::program_options::value<std::string>(&cameraName)->default_value(""), "Name of camera")
